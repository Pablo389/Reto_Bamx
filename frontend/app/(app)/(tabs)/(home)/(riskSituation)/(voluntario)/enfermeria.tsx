...
export default function EnfermeriaPage() {
  ...
  const [slots, setSlots] = useState([
    {
      ...
      time: "08:00 - 14:00",
      available: 3,
      location: "https://goo.gl/maps/abcdefghij",
    },
    {
      id: 2,
      date: "2023-11-25",
      time: "14:00 - 20:00",
      available: 2,
      location: "https://goo.gl/maps/klmnopqrst",
    },
    {
      id: 3,
      date: "2023-11-26",
      time: "08:00 - 14:00",
      available: 4,
      location: "https://goo.gl/maps/uvwxyzabcd",
    },
    {
      id: 4,
      date: "2023-11-26",
      time: "14:00 - 20:00",
      available: 1,
      location: "https://goo.gl/maps/efghijklmn",
    },
  ]);
  ...
  const confirmSignUp = () => {
    Alert.alert(
      "Registro Exitoso",
      "Te has registrado para este turno de enfermería. Se han enviado instrucciones específicas a tu correo. Gracias por tu ayuda!",
      [{ text: "OK" }]
    );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.subtitle}>
          Brinda apoyo médico y cuidados en Acapulco
        </Text>
      </View>
