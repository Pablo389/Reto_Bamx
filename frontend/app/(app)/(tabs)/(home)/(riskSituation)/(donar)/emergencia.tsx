...
export default function EmergenciaPage() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (docSnap.exists()) {
          ...
          if (data.itemsEmergencia && Array.isArray(data.itemsEmergencia)) {
            setEmergencyItems(data.itemsEmergencia);
          } else {
            setEmergencyItems([]);
          }
        } else {
  ...
  const handleOpenLocation = () => {
    if (
      riskSituation &&
      riskSituation.itemsEmergenciaLocation &&
      riskSituation.itemsEmergenciaLocation.location
    ) {
      Linking.openURL(riskSituation.itemsEmergenciaLocation.location).catch(
  ...
  const locationName =
    riskSituation.itemsEmergenciaLocation?.name || "Centro de Acopio";
  const locationUrl = riskSituation.itemsEmergenciaLocation?.location;
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Artículos de Emergencia</Text>
      </View>

      <View style={styles.infoContainer}>
        <Text style={styles.infoTitle}>
          Estos son los artículos de emergencia que se necesitan
        </Text>
        {locationUrl && (
          <TouchableOpacity
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.emptyListText}>
            No hay artículos de emergencia disponibles.
          </Text>
        }
      />
    </SafeAreaView>
